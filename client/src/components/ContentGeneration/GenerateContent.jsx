...
import { generateContentAPI } from "../../apis/gemini/geminiAPI";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-900 flex justify-center items-center p-6">
      <div className="bg-white rounded-xl shadow-xl overflow-hidden max-w-2xl w-full p-6">
        ...
        { mutation.isSuccess && <StatusMessage type="success" message="Content generation is successfully" /> }
        ...
        {mutation.data && (
          <div className="mt-6 p-4 bg-gray-100 rounded-md">
            ...
            <p className="text-gray-600" dangerouslySetInnerHTML={{ __html: mutation.data }}></p>
          </div>
        )}
      </div>
    </div>
