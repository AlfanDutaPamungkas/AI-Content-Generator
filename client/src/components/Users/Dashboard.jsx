        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="mb-6 bg-white p-4 shadow rounded-lg">
            ...
            <div>
              ...
              <p className="mb-4">Next Billing Date: {data.user.nextBillingDate ? new Date(data.user.nextBillingDate).toLocaleDateString() : "No Billing Date" } </p>
            </div>
          </div>
          ...
          <div className="mb-6 bg-white p-4 shadow rounded-lg">
            ...
            <div>
              ...
              <Link
                to="/plans"
                className=" py-2 px-4 mr-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-purple-500 to-blue-500 hover:from-indigo-600 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                Upgrade Plan
              </Link>
              {data.user.activeOrderID && (
                <Link
          ...
          <div className="mb-6 bg-white p-4 shadow rounded-lg">
            ...
            <div>
              ...
              <span className="text-green-500">Active</span> : <span className="text-yellow-600">Inactive</span>
              }</p>
                    ...
                    <li key={payment._id} className="py-4 hover:bg-gray-50 transition duration-150 ease-in-out">
                      <div className="flex flex-col sm:flex-row justify-between">
                        ...
                        <div className="flex items-center">
                          <p className={`text-sm font-semibold ${payment.status == "success" ? "text-green-500" : "text-yellow-500 "} `}>
                            {payment.status}
                          </p>
                          <p className="text-sm text-gray-700 ml-4">Rp {payment.amount}</p>
                        </div>
                      </div>
                    </li> 
                  )
